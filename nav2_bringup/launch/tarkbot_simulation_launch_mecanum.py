...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'nav2_params_teb_mecanum.yaml'),
    ...
    robot_description = process_file(os.path.join(bringup_dir, 'mecanum_model','mecanum.urdf.xacro')).toxml()
